...
class QuizApp(tk.Tk):
    def __init__(self):
        ...
        self.selected_bank_name: str | None = None
        self.selected_questions: list[Question] | None = None
    ...
    def start_quiz(self, bank_name: str, count: int, shuffle: bool, show_answers: bool):
        ...
        quiz_frame: QuizFrame = self.frames["QuizFrame"]
        quiz_frame.reset()
    ...
    def finish_quiz(self):
        ...
        result_frame: ResultFrame = self.frames["ResultFrame"]
    ...
    def render_results(self):
        ...
        if session.show_answers:
            for i, rec in enumerate(records, start=1):
                ...
                title = ttk.Label(block, text=f"Q{i}. {q.prompt}", wraplength=760, justify="left",
            ...
            info = ttk.Label(self.scrollable_frame, text="Answer review is disabled. Enable it on the start screen.",
                             foreground="#555")
