...
class Game:
    def __init__(self):
        ...
        self.btn_next.addEventListener("click", create_proxy(self.on_next))
        self.btn_retry.addEventListener("click", create_proxy(self.on_retry))
    ...
    def start(self):
        ...
        window.requestAnimationFrame(self._frame_cb)
    ...
    def on_keydown(self, evt):
        ...
        if key == "Space" or getattr(evt, "key", "") == " ":
