...
from constants import GRID_SIZE, SYMBOL_X, SYMBOL_O, COLORS, FONTS
...
class TicTacToeGUI:
    ...
    def update_status(self) -> None:
        ...
        if self.game.winner is not None:
            ...
            self.status_label.config(text="It's a draw. Start a new game!")
        else:
            self.status_label.config(text=f"Turn: Player {self.game.current_player}")
