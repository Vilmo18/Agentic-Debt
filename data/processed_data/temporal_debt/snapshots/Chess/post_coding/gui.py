...
Optional Tkinter GUI for the chess engine. Uses Unicode chess glyphs and allows click-to-move,
including castling, en passant, and promotion via a dialog.
...
from engine.utils import piece_unicode, index_to_coord, coord_to_index, index_to_square
...
class ChessGUI(tk.Tk):
    ...
    def on_click(self, row: int, col: int):
        ...
        if self.selected is None:
            ...
            state = self.board.make_move(chosen_move)
