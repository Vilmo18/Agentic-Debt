...
FLAG_CHAR = "🚩"  # Distinct visual for flagged cells
MINE_CHAR = "💣"
...
class MinesweeperApp(tk.Frame):
    ...
    def _build_controls(self):
        ...
        tk.Label(footer, text="Left-click: reveal | Right-click: flag/unflag", bg="#f2f2f2").pack(side="left")
    ...
    def _on_right_click(self, x, y):
        if self.game.state != "playing":
            return
        flagged = self.game.right_click(x, y)
