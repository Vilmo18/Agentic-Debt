...
- WordleGame manages state, validation, submission, and knowledge of keyboard letters.
'''
...
class WordleGame:
    ...
    def validate_guess(self, guess: str) -> Tuple[bool, str]:
        """
        Ensure the guess is 5 alphabetic letters.
        We do not enforce dictionary membership to keep the game lightweight.
        """
        if guess is None:
